...
public class BatchHistoryCleanupTasklet implements Tasklet, InitializingBean {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(BatchHistoryCleanupTasklet.class);

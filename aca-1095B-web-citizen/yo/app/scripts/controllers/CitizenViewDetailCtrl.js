/**
 * Created by pchavan on 9/28/2015.
 */
...
(function () {
  ...
  function CitizenViewDetailCtrl($scope, $log, $element, $sce, $interval, $document, $state, CitizenService, CitizenInactive, inactivityModal, CitizenSession){
    ...
    vm.printDiv = function(divClass) {
      CitizenService.printDiv(divClass);
    };
    ...
    vm.initializeLabels = function(){
      ...
      var timerFocus = $interval(function(){
          $('.citizen-view-detail-container .title').eq(0).focus();

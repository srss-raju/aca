...
public class ApplicationConfigCP {

    private static final Logger logger = LoggerFactory.getLogger(ApplicationConfigCP.class);

    @Bean
    public FilerMapper filerMapper(){return new FilerMapper();}

    private static final Logger LOG = LoggerFactory.getLogger(ApplicationConfigCP.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        try{
            SpringApplication app = new SpringApplication(ApplicationConfigCP.class);

...
@XmlRootElement(name = "EmployeeCoverageErrorDtl")
public class EmployeeCoverageErrorDtlImpl
    implements EmployeeCoverageErrorDtl
{

    @XmlElement(name = "CompletePersonNameErrorDtl", required = true, type = CompletePersonNameErrorDtlImpl.class)
    ...
    protected EmployeeSHOPPolicyErrorDtlImpl employeeSHOPPolicyErrorDtl;
    ...
    public EmployeeSHOPPolicyErrorDtl getEmployeeSHOPPolicyErrorDtl() {
        return employeeSHOPPolicyErrorDtl;
    }

    public void setEmployeeSHOPPolicyErrorDtl(EmployeeSHOPPolicyErrorDtl value) {
        this.employeeSHOPPolicyErrorDtl = ((EmployeeSHOPPolicyErrorDtlImpl) value);
    }

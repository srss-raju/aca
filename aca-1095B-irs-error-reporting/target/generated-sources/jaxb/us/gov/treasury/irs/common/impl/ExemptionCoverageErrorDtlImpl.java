...
@XmlRootElement(name = "ExemptionCoverageErrorDtl")
public class ExemptionCoverageErrorDtlImpl
    implements ExemptionCoverageErrorDtl
{

    @XmlElement(name = "ExemptPersonErrorDtl", type = EPDPersonErrorDtlTypeImpl.class)
    protected EPDPersonErrorDtlTypeImpl exemptPersonErrorDtl;
    ...
    public void setExemptPersonErrorDtl(EPDPersonErrorDtlType value) {
        this.exemptPersonErrorDtl = ((EPDPersonErrorDtlTypeImpl) value);
    }

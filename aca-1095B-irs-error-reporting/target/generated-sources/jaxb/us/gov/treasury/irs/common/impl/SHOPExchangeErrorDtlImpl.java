...
@XmlRootElement(name = "SHOPExchangeErrorDtl")
public class SHOPExchangeErrorDtlImpl
    implements SHOPExchangeErrorDtl
{

    @XmlElement(name = "EIN", required = true)
    protected String ein;
    @XmlElement(name = "SHOPEmployerErrorDtl", type = SHOPEmployerErrorDtlImpl.class)

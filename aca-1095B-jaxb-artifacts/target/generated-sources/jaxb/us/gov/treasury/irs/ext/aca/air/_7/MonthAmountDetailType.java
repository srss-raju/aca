...
@XmlType(name = "MonthAmountDetailType", propOrder = {
    "monthNum",
    "monthAmt"
})
public class MonthAmountDetailType {

    @XmlElement(name = "MonthNum")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected int monthNum;
    @XmlElement(name = "MonthAmt")
    protected long monthAmt;
    ...
    /**
     * Gets the value of the monthAmt property.
     * 
     */
    ...
    /**
     * Sets the value of the monthAmt property.
     * 
     */
    public void setMonthAmt(long value) {
        this.monthAmt = value;
    }

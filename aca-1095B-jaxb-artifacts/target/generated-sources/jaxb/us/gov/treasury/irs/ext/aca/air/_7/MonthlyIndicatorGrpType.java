...
@XmlType(name = "MonthlyIndicatorGrpType", propOrder = {
    "monthIndicatorDetail",
    "errorDetail"
})
public class MonthlyIndicatorGrpType {

    @XmlElement(name = "MonthIndicatorDetail", required = true)
    protected List<MonthIndicatorDetailType> monthIndicatorDetail;
    @XmlElement(name = "ErrorDetail")
    protected List<EPDErrorDetailType> errorDetail;

    /**
     * Gets the value of the monthIndicatorDetail property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the monthIndicatorDetail property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMonthIndicatorDetail().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MonthIndicatorDetailType }
     * 
     * 
     */
    public List<MonthIndicatorDetailType> getMonthIndicatorDetail() {
        if (monthIndicatorDetail == null) {
            monthIndicatorDetail = new ArrayList<MonthIndicatorDetailType>();
        }
        return this.monthIndicatorDetail;
    }

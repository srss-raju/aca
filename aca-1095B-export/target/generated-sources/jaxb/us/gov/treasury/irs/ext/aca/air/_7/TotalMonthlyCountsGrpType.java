...
public class TotalMonthlyCountsGrpType {

    @XmlElement(name = "MonthCountDetail", required = true)
    protected List<MonthCountDetailType> monthCountDetail;
    @XmlElement(name = "ErrorDetail")
    protected List<EPDErrorDetailType> errorDetail;

    /**
     * Gets the value of the monthCountDetail property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the monthCountDetail property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMonthCountDetail().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MonthCountDetailType }
     * 
     * 
     */
    public List<MonthCountDetailType> getMonthCountDetail() {
        if (monthCountDetail == null) {
            monthCountDetail = new ArrayList<MonthCountDetailType>();
        }
        return this.monthCountDetail;
    }

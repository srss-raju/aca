...
public class ACABatchManifestDetailType {
    ...
    @XmlElement(name = "ACAReportingServiceDetail")
    protected ACAReportingServiceDetailType acaReportingServiceDetail;
    @XmlElement(name = "ACAAttachmentDetail", required = true)

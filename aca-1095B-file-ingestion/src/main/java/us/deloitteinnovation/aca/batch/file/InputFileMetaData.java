package us.deloitteinnovation.aca.batch.file;

import us.deloitteinnovation.aca.batch.util.StateCode;
import us.deloitteinnovation.aca.batch.validator.USStateCode;
...
public class InputFileMetaData {
    ...
    @NotNull
    @USStateCode(acceptValues = StateCode.class, message = "{filename.state.code.invalid}")
    private String stateCode;

    @NotNull
    @Pattern.List({
            @Pattern(regexp = "[a-zA-Z]{3}", message = "{filename.agency.code.invalid}"),
            @Pattern(regexp = "^(DHS|FSS|DHH|DCI)$", message = "{filename.agency.code.invalid}")
    })
    ...
    @Pattern.List({
            ...
            @Pattern(regexp = "^(DSS|ICE|EES|INV)$", message = "{filename.system.code.invalid}")
    })
    private String systemCode;


    @NotNull
    @Pattern(regexp = "^(0[1-9]|1[012]|99)(0[1-9]|[129][0-9]|3[01])(2015|2016|2017)$", message = "{filename.date.invalid}")
    private String date;
     ...
     */
    public InputFileMetaData setFileName(String fileName) {
     ...
     */
    public InputFileMetaData setStateCode(String stateCode) {
     ...
     */
    public InputFileMetaData setAgencyCode(String agencyCode) {
     ...
     */
    public InputFileMetaData setSystemCode(String systemCode) {
     ...
     */
    public InputFileMetaData setDate(String date) {
        this.date = date;
        return this;
    }
     ...
     */
    public InputFileMetaData setVersion(String version) {
     ...
     */
    public InputFileMetaData setTaxYear(String taxYear) {
     ...
     */
    public InputFileMetaData setExtension(String extension) {
     ...
     */
    public InputFileMetaData setRecordCountInHeader(Integer recordCountInHeader) {
     ...
     */
    public InputFileMetaData setRecordCountInFile(Integer recordCountInFile) {

...
public class PrintVendorExceptionLogger implements JobExecutionDecider {

    private static final Logger LOGGER = LoggerFactory.getLogger(PrintVendorExceptionLogger.class);
    String year;
    String state;
    boolean goAhead;
